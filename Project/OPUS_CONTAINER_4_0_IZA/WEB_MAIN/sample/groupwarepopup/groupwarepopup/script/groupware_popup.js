...
/**
 * @extends
 * @class groupware_popup : groupware_popup 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function groupware_popup() {
...
// sheetObject 배열화를 위한 setSheetObject 메소드를 만든다.
/**
...
function sheet1_OnPopupClick(sheetObj) {
	if (sheetObj.id == "sheet1") {
		ComOpenGroupwareMail(sheetObj, document.form);
	}
}
