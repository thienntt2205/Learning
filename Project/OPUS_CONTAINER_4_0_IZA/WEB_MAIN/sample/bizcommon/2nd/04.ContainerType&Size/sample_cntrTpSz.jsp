...
ComOpenPopup('/opuscntr/COM_ENS_0G1.do' + param, 620, 480, 'getCOM_ENS_0G1_1', v_display, true);
...
ComOpenPopupWithTarget('/opuscntr/COM_ENS_0G1.do' + param, 620, 480, "3:cntr_tpsz_cd|4:cntr_tpsz_desc", v_display, true);
    ...
    <tr>
    	<td>
    		...
    		- Container Type/Size <%= com.clt.bizcommon.util.BizComUtil.getCodeCombo("cntr_tpsz_cd2", "", "", "CNTRTPSZ", 1, "0: :ALL") %>
    	</td>
    </tr>
  </table>
</form>
