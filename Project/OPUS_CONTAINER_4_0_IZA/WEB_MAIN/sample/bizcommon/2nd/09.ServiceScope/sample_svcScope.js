        ...
        switch(srcName) {
            case "svc_scp_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_1', v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
