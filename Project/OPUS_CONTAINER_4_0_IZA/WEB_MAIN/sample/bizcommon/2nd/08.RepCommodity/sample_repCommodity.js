        ...
        switch(srcName) {
            case "rep_cmdt_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopupWithTarget('/opuscntr/COM_ENS_0K1.do' + param, 505, 430, "3:rep_cmdt_cd|4:rep_cmdt_nm", v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0K1.do' + param, 505, 430, 'getCOM_ENS_0K1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0K1.do' + param, 505, 430, 'getCOM_ENS_0K1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
