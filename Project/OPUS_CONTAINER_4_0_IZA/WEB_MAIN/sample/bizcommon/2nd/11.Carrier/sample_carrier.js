        ...
        switch(srcName) {
            case "carr_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopupWithTarget('/opuscntr/COM_ENS_0N1.do' + param, 420, 430, "3:crr_cd|4:crr_nm", v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0N1.do' + param, 420, 430, 'getCOM_ENS_0N1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0N1.do' + param, 420, 430, 'getCOM_ENS_0N1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
