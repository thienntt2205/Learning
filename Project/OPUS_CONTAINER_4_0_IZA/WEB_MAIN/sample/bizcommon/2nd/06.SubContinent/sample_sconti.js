        ...
        switch(srcName) {
            case "sconti_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopupWithTarget('/opuscntr/COM_ENS_0I1.do' + param, 405, 410, "3:sconti_cd|4:sconti_nm", v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0I1.do' + param, 405, 410, 'getCOM_ENS_0I1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0I1.do' + param, 405, 410, 'getCOM_ENS_0I1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
