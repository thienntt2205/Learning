        ...
        switch(srcName) {
            case "exrate_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0E1.do' + param, 520, 470, 'getCOM_ENS_0E1_1', v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0E1.do' + param, 520, 470, 'getCOM_ENS_0E1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/opuscntr/COM_ENS_0E1.do' + param, 520, 470, 'getCOM_ENS_0E1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
