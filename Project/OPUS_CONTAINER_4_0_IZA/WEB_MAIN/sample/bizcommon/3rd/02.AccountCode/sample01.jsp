	...
	<td width="180" class="title">
          ...
          <tr>
            <td bgcolor="#FFFFFF" align="left" colspan="4">
            	<pre>
ComOpenPopupWithTarget('/opuscntr/COM_ENS_N11.do?classId=COM_ENS_N11&' + param, 500, 380, 'acct_cd:acct_cd|acct_eng_nm:acct_eng_nm', v_display + ',1', true);

ComOpenPopup('/opuscntr/COM_ENS_N11.do?classId=COM_ENS_N11&' + param, 500, 380, 'getCOM_ENS_N11', v_display + ',1', true);
            	</pre>
            </td>
          </tr>
        </table>
