...
<%@ page import="com.clt.bizcommon.trade.event.ComCom0012Event"%>
<%
	ComCom0012Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {  
		...
		*/
		event = (ComCom0012Event)request.getAttribute("Event");
		/* 
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>Trade Code Inquiry</span></h2>
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry wFit">
			...
			<tr class="h23">
				...
				<td width=""><input type="text" style="width:50px;ime-mode:disabled;text-align:center" class="input" name="code" maxlength="3" dataformat="engup"></td>
				<th width="80px">&nbsp;Description</th>
				<td width="">&nbsp;<input type="text" style="width:350px;ime-mode:disabled;text-align:left" class="input" name="desc" maxlength="50" dataformat="engupetc"></td>
				<%
