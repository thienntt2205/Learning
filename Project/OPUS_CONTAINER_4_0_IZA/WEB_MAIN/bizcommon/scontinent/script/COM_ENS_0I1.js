        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
             ...
             if(mainPage == undefined){
            	 HeadTitle="||Seq.|Code|Name|Continent" ;
             }else{
            	 HeadTitle="Seq.|Code|Name|Continent" ;
             }
             ...
             //(headCount, 0, 0, true);
	             ...
	             if(mainPage == undefined){
		             var cols = [ {Type:"Radio",     Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"radio",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
				                 ...
				                 {Type:"Text",      Hidden:0,  Width:180,  Align:"Left",    ColMerge:0,   SaveName:"sconti_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
				                 {Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:0,   SaveName:"conti_nm",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
		             if(mdmYN.replace(/\s/g,"") != ""){
		            	 cols.push({Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"delt_flg",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
		             }
	             }else{
        ...
        switch(sAction) {
          case IBSEARCH:        //조회
                ...
                selectVal=FormQueryString(formObj)
                 sheetObj.DoSearch("COM_ENS_0I1GS.do", selectVal );
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value=SEARCHLIST;  
                 sheetObj.DoSearch("COM_ENS_0I1GS.do", selectVal+"&"+ "iPage=" + PageNo,{Append:true} );
           break;
        }
    }
