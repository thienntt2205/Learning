...
<%@ page import="com.clt.bizcommon.scontinent.event.ComEns0I1Event"%>
<%@ page import="com.clt.bizcommon.scontinent.vo.SearchSubContinentListVO"%>
<%
...
<div class="page_title_area clear">
   <!-- page_title(S) -->
	<h2 class="page_title"><button type="button">Sub Continent Code</button></h2>
	<!-- page_title(E) -->
		<%if(!main_page.equals("true")){ %>	
	<!-- opus_design_btn(S) -->
...
<div class="page_title_area clear">
   <!-- page_title(S) -->
	<h2 class="page_title"><button type="button"><span>Sub Continent Code</span></button></h2>
	<!-- page_title(E) -->
		<%if(!main_page.equals("true")){ %>
...
<!-- page_title_area(E) -->	
			<%//out.print("mdm_yn => "+mdm_yn+"&nbsp;"); out.print("delt_flg => "+delt_flg+"");%>
<%} %>	
	...
	<div class= "opus_design_inquiry wFit">
		<table>
			<tbody>
				...
				<tr>
					<th>Code</th>
					<td><input type="text" name="sconti_cd" style="width:30px;ime-mode:disabled" maxlength="2" dataformat="enguponly" id="sconti_cd" /> </td>
					<th>Name</th>
					<td><input type="text" name="sconti_nm" style="width: 80px;" id="sconti_nm" /> </td>
					<%
				...
				<!-- <tr class="line_bluedot"><td colspan="4"></td></tr> -->
			</tbody>
		</table>
	</div>
</div>
...
<!--
      ...
      */
      with(document.form)
      {
        <%
        if(event != null){ 
        	SearchSubContinentListVO vo = event.getSearchSubContinentListVO();
        	String sContiCd = "";
        	String sContiNm = "";
        	if(vo != null){
        		sContiCd = vo.getScontiCd();
        		sContiNm = vo.getScontiNm();
        	}     
        %>
            eval("sconti_cd").value = "<%=sContiCd%>";
            eval("sconti_nm").value = "<%=sContiNm%>";
        <% } %>
       }
-->
</SCRIPT>
