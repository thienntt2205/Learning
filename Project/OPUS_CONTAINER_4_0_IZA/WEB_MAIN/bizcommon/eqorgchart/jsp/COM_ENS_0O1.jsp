...
<%@ page import="com.clt.bizcommon.eqorgchart.event.ComEns0O1Event"%>
<%
...
<input type="hidden" name="chkDepth" value="<%= chkDepth %>" id="chkDepth" />
<input type="hidden" name="scc_flag" value="<%= sccFlag %>" id="scc_flag" />
...
<h2 class="page_title"><span>EQ Organization Chart</span></h2>
<!-- page_title(E) -->
<!-- opus_design_btn(S) -->
