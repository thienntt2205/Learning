...
<%@ page import="com.clt.bizcommon.carrier.event.ComEns0N1Event"%>
<%
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry">
			<table class="search" border="0" > 
				<tr>
					<td width="90px">Carrier Code</td>
					<td width="90px"><input type="text" name="crr_cd" style="width:70px" maxlength="3" dataformat="engup"></td>
					<td width="50px">Name</td>
					<td width="120px"><input type="text" name="crr_nm" style="width:100px" dataformat="excepthan"></td>
				<%
