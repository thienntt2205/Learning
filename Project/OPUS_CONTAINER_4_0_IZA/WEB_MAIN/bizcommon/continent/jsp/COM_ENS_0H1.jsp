...
<%@ page import="com.clt.bizcommon.continent.event.ComEns0H1Event"%>
<%@ page import="com.clt.bizcommon.continent.vo.SearchContinentListVO"%>
<% 
...
<!-- layer_popup_title(S) -->
 <div class="layer_popup_title">
    ...
    <div class="page_title_area clear" >
        <!-- page_title(S) -->
        <h2 class="page_title">
            <span>Continent Code Inquiry</span>
        </h2>
        <!-- page_title(E) -->
	    ...
	    <div class="opus_design_inquiry wFit">
	        ...
	        <table>
	            ...
	            <tbody>
	                <tr>
	                    <th>Code</th>
	                    <td><input type="text" name="conti_cd" dataformat="engup" maxlength="1"  size="1" style="width:30px"></td>
	                    <th>Name</th>
	                    <td><input type="text" style="width:60px" name="conti_nm" maxlength="8" dataformat="engup"></td>
	                    <%
	                        if(!"".equals(mdm_yn) && mdm_yn.length() > 0){
	                    %>
	                       <th>Status</th>
      ...
      */
      with(document.form)
      {
        ...
        if(event != null){ 
            ...
            SearchContinentListVO vo = event.getSearchContinentCodeInquiryListVO();
            String conti_cd = "";
            String conti_nm = "";
            
            if(vo != null){
                conti_cd = vo.getContiCd();
                conti_nm = vo.getContiNm();
            }
        %>
            eval("conti_cd").value = "<%=conti_cd%>";
            eval("conti_nm").value   = "<%=conti_nm%>";
        <% } %>
       }
-->
</script>
