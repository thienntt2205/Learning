...
<%@ page import="com.clt.bizcommon.state.event.ComEns0X1Event"%>
<%@ page import="com.clt.bizcommon.state.event.ComEns0X1EventResponse"%>
<% 
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>State/Province Code Inquiry</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
		...
		<div class="opus_design_inquiry wFit">
			<table> 
				...
				<tbody>
					<tr>
							<th>Country Code</th>
						    <td><input name="cnt_cd" type="text" style="width:100;ime-mode:disabled" dataformat="engup" maxlength="2" value=""></td>
						<%
