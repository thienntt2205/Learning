        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
	                ...
	                var HeadTitle="||No|Code|Name|Cnt Code|Locl. State\nCode" ;
	                if(mdmYN.replace(/\s/g,"") != ""){
	                HeadTitle += "|Status";
	                }
	                ...
	                var cols = [ {Type:"Radio",     Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"radio",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
	                 ...
	                 {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"modi_ste_cd", KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
	                            if(mdmYN.replace(/\s/g,"") != ""){
