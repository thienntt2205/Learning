...
<%@ page import="com.clt.bizcommon.servicescope.event.ComEns0L1Event"%>
<%
...
<input type="hidden" name="mdm_yn" id="mdm_yn" value="<%=mdm_yn%>">
	...
	<div class="layer_popup_title">
		<div class="page_title_area clear">
			<h2 class="page_title"><span>Service Scope Code Inquiry</span></h2>
				...
				%>	                   	                
		            ...
		            <tbody>
		                <tr>
		                    <th>SVC SCP.</th>
		                    <td>
		                    	<input type="text" name="svc_scp_cd" id="svc_scp_cd" style="width:55px" maxlength="3" dataformat="enguponly">
		                    </td>
		                    <th>Name</th>
		                    <td>
		                    	<input type="text" name="svc_scp_nm" id="svc_scp_nm" style="width:100px" dataformat="engupetc">
		                    </td>
					<%
						if(!"".equals(mdm_yn) && mdm_yn.length() > 0){
					%>
