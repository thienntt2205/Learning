...
<%@ page import="com.clt.bizcommon.leasingcompanyyard.event.ComCom0004Event"%>
<%@ page import="com.clt.bizcommon.leasingcompanyyard.vo.SearchLeasingCompanyYardListVO"%>
<%
...
<div class="layer_popup_contents">
	...
	<div class="page_title_area clear">
	   ...
	   <%if(main_page.equals("true")){ %>
		...
		<%} else { %>
		<h2 class="page_title"><span>Leasing Company Yard Code Inquiry</span></h2>
		<%} %>	
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
