    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                ...
                HeadTitle="| |Seq.|Code|Description|Trade" ;
                }else{
                HeadTitle="Seq.|Code|Description|Trade" ;
                }
                ...
                var cols = [ {Type:"Radio",     Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"radio",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                    ...
                    {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"sub_trd_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                    {Type:"Text",      Hidden:0,  Width:350,  Align:"Left",    ColMerge:0,   SaveName:"sub_trd_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                 ...
                 if(mdmYN.replace(/\s/g,"") != ""){
                	 	cols.push({Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"status",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
                 }
                InitColumns(cols);
        ...
        switch(sAction) {
          case IBSEARCH:        //조회
               ...
               // sheetObj.DoSearch4Post("COM_COM_0012GS.do", selectVal);               
          			formObj.f_cmd.value=SEARCH;                
					selectVal=FormQueryString(formObj);
                    sheetObj.DoSearch("COM_COM_0013GS.do", selectVal );
           break;
        }
    }
   /**
