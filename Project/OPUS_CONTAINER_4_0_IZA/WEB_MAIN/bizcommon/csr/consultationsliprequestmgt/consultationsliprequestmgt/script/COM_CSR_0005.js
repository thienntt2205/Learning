 ...
 ***************************************************************************************/
    /**
     * @extends
     * @class COM_CSR_0005 : business script for COM_CSR_0005 
     */
    	...
    	try {
			...
			switch(srcName) {
				case "btng_ok_k":
					...
					if(isNull2(comboObjects[0].GetSelectCode())){
    		        ...
    		        document.form.tax_no2.value=comboObjects[0].GetSelectCode();
    		        if(comboObjects[0].GetSelectCode()!= ""){
    				   form.f_cmd.value=SEARCH02;
    				   sheetObjects[0].SetWaitImageVisible(0);
    				   sXml1=sheetObjects[0].GetSearchData("COM_CSR_0004GS.do" , FormQueryString(form));
				...
				case "btng_delete_k":
		     		...
		     		var total_amt=0;
		 				for(var i=0;i<sheetObjects[0].RowCount();i++){
		 					net_amt=parseFloat(sheetObjects[0].GetCellValue(i+1,4)*100)+parseFloat(csr_deleteComma(net_amt));
		 				}
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           case IBINSERT:      // inserting
                ...
                break;
           case IBCOPYROW:        //copying the row
              sheetObj.DataCopy();
              break;
