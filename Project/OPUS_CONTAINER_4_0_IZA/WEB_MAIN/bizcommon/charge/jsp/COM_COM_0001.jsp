...
<%@ page import="com.clt.bizcommon.charge.event.ComCom0001Event"%>
<%
	ComCom0001Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComCom0001Event)request.getAttribute("Event");
		/* 
...
<div class="layer_popup_contents">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Charge Code Inquiry</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_Retrieve" 	id="btn_Retrieve">Retrieve</button><!--
			--><span id="btn_Retrieve"><button type="button" class="btn_normal" name="btn2_Down_Excel" id="btn2_Down_Excel">Down Excel</button></span><!--
		...
		<div class= "opus_design_inquiry wFit">
			<table>
				...
				<tbody>
					<tr>
						<th>Code</th>
						<td><input type="text" name="chg_cd" style="width:70px;text-align:center" maxlength="4" dataformat="engup" id="chg_cd" /> </td>
						<th>Description</th>
						<td><input type="text" name="chg_nm" style="width:200px;" maxlength="50" dataformat="engupetc" id="chg_nm" /> </td>
						<th>Rep. Charge</th>
						<td><select style="width:60px;" name="rep_chg_cd"></select>
					<%
...
<!--
	  ...
	  */
	  ...
	  {
		<%
		if(event.getChargeListVO() != null){ 
			   String chgCd   =	event.getChargeListVO().getChgCd();
			   String chgNm   =	event.getChargeListVO().getChgNm();			   
		%>
		eval("chg_cd" ).value = "<%= chgCd %>";
		eval("chg_nm" ).value = "<%= chgNm %>";
		<% } %>
	   }
-->
</SCRIPT>
