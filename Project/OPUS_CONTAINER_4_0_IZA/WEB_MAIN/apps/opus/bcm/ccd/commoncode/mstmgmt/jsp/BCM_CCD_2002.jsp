...
<div class="opus_design_inquiry wFit">
	...
	<table> 
		...
		<tr class="h23">
			...
			<td><input id="ofc_cd" style="width: 90px; ime-mode:disabled; text-align:center" class="input" name="ofc_cd" dataformat="engup" maxlength="6" type="text" onBlur="obj_change();"/>
			   <button class="input_seach_btn" name="btns_search4" id="btns_search4" type="button"></button>
			</td>
			
			<th>Admin Office</th>
			<td><input id="adm_ofc_cd" style="width: 90px; ime-mode:disabled; text-align:center" class="input" name="adm_ofc_cd" dataformat="engup" maxlength="6" type="text" onBlur="obj_change();"/>
			   <button class="input_seach_btn" name="btns_search5" id="btns_search5" type="button"></button>
			</td>		
