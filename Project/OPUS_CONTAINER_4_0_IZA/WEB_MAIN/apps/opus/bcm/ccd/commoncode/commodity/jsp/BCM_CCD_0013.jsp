...
<%@ page import="com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0013Event"%>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:50px;text-align:center;ime-mode:disabled;" class="input1" dataformat="engup" name="pck_cd" id="pck_cd" maxlength="2"" onBlur="obj_change();"><!--
                        --><button type="button" class="input_seach_btn" name="btns_search" id="btns_search"></button>
                    </td>
                    <th>Name</th>
                    <td><input type="text" style="width:70%;text-align:left;" class="input1" dataformat="engup" otherchar="()_\-,. " name="pck_nm" id="pck_nm" maxlength="50"></td>
                </tr>
            </tbody>
        </table>
    </div>
