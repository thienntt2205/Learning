...
<%@ page import="com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0017Event"%>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <th>Region Code</th>
                    <td>
                        <input type="text" style="width:50px;ime-mode:disabled;text-align:center" name="rgn_cd" class="input1" dataformat="engup" maxlength="3" id="rgn_cd" onBlur="obj_change();"/><!--
                        --><button type="button" name="btns_search2" id="btns_search2" class="input_seach_btn"></button></td>
                    <th>Name</th>
                    <td><input type="text" style="width:60%;" class="input1" dataformat="engup" otherchar="()_\-,. " name="rgn_nm"  maxlength="50" id="rgn_nm" /></td>
                </tr>   
            </tbody>
        </table>
    </div>
