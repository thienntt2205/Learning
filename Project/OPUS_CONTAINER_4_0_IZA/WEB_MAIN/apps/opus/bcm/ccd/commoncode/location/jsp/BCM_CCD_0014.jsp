...
<%@ page import="com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0014Event"%>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:50px;ime-mode:disabled;text-align:center" name="conti_cd" id="conti_cd" class="input1" dataformat="enguponly" maxlength="1" onBlur="obj_change();"><!--
                        --><button type="button" class="input_seach_btn" name="btns_search1" id="btns_search1"></button></td>
                    <th>Name</th>
                    <td><input type="text" style="width:60%;" dataformat="engup" otherchar="()_\-,. " name="conti_nm" id="conti_nm" class="input1"  maxlength="50"></td>
                </tr>
            </tbody>
        </table>
    </div>
