...
<%//@ page import="com.clt.apps.opus.bcm.ccd.commoncode.service.event.ComCom1002Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@page import="com.clt.syscommon.common.table.ComUsrRoleVO"%>
<%@page import="com.clt.syscommon.common.util.UserRoleUtil"%>

<%
	//LeeKyungHee-ComCom1002Event가 없어서 일단 주석으로 마이그레이션 했음
	//ComCom1002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		//LeeKyungHee-ComCom1002Event가 없어서 일단 주석으로 마이그레이션 했음
		//event = (ComCom1002Event)request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">   <!-- no TAB  -->
		<table>
			<tr>
				...
				<td><input type="text" style="width:80;text-align:center;ime-mode:disabled" class="input" maxlength="4" name="err_vsl_cd" dataformat="engup"></td>																										
			</tr>
		</table>
	</div>
</div>
