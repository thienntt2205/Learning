...
*/
	...
	function processButtonClick() {
		...
		try {
			...
			//downexcel, loadexcel 추가. 20171110 mkkim start
			case "btn_downexcel":
			...
			case "btn_add":
				...
				sheetObject.SetCellValue(row, "cust_cnt_cd", formObject.s_cust_cd.value.substring(0,2)); //20171116 mkkim add
				sheetObject.SetCellValue(row, "cust_seq", formObject.s_cust_cd.value.substring(2)); //20171116 mkkim add
				sheetObject.SetCellValue(row, "edi_snd_itval_hrmnt", 0);	//20171116 mkkim add
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
			with(sheetObj) {
			  var HeadTitle = "|Seq|Del|Group Code|Company Div.|Country|Customer Seq.|Standard Status|Status Seq.|Customer EDI Status|EDI Event|EDI Send Flag|Vessel Type|Send Interval|CNTR Send Type|Event Date|Origin Continent|Origin Country|Dest. Continent|Dest. Country|Remark|Auto Send Flag";
              ...
              var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
                           ...
                           {Type:"Text",      Hidden:0,  Width:105,  Align:"Center",  ColMerge:0,   SaveName:"edi_grp_cd",           KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:10, AcceptKeys:"E|N", InputCaseSensitive:1 },
                           ...
                           {Type:"Text",      Hidden:0,  Width:120,  Align:"Center",  ColMerge:0,   SaveName:"cust_cnt_cd",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:2, AcceptKeys:"E|N", InputCaseSensitive:1 },
						   {Type:"Text",      Hidden:0,  Width:120,  Align:"Center",  ColMerge:0,   SaveName:"cust_seq",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:6 },
                           ...
                           {Type:"Text",      Hidden:0, Width:130,  Align:"Center",  ColMerge:0,   SaveName:"edi_sts_seq",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                           ...
                           {Type:"Text",      Hidden:0, Width:130,  Align:"Center",  ColMerge:0,   SaveName:"eai_evnt_dt",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                           ...
                           {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"cre_usr_id",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
      	                   {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"cre_dt",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
      	                   {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"upd_usr_id",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
      	                   {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"upd_dt",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:1 },	
      	                   {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"edw_upd_dt",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
              InitColumns(cols);
              SetEditable(1);
              SetColProperty("edi_evnt_cd", {ComboText: "All|First|Not first|Last|Not last", ComboCode: "5|1|2|3|4"});
              SetColProperty("edi_snd_flg", {ComboText: "Y|N", ComboCode: "Y|N"});
              ...
              SetColProperty("edi_auto_snd_flg", {ComboText: "Y|N", ComboCode: "Y|N"});
	...
	function doActionIBSheet(sheetObj, formObj, sAction, Col, Row) {
		...
		case IBSEARCH: // retrieving
			if (validateForm(sheetObj, formObj, sAction)) {
				...
				var sXml = sheetObj.GetSearchData("BCM_SUP_0090GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(""));
		...
		case IBSAVE:
			...
			if (sheetObj.RowCount() == 0 || (!sheetObj.IsDataModified && sParam == "")) {
				ComShowCodeMessage("SUP00002"); // save 할 내용이 없는 경우. 20171122 mkkim
				return;
			}
			var aryPrefix = new Array("");
			sParam += "&" + FormQueryString(formObj) + "&" + ComGetPrefixParam(aryPrefix);
			var sXml = sheetObj.GetSaveData("BCM_SUP_0090GS.do", sParam);
		...
		case IBDOWNEXCEL:
			...
			// hidden 컬럼 포함하여 download하도록 옵션 수정, 20171113 mkkim
