...
<%@ page import="com.clt.apps.opus.dou.doutraining.errmsgmgmt.event.DouTrn001Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	DouTrn001Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (DouTrn001Event)request.getAttribute("Event");
