...
<%@ page import="com.clt.apps.opus.fns.joo.training.joocarriermgmt.event.FnsJoo0901Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0901Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String rlaneCds			= "";
	String crrCds			= "";
	Logger log = Logger.getLogger("com.clt.apps.Training.JooCarrierMgmt");
	...
	try {
		...
		event = (FnsJoo0901Event)request.getAttribute("Event");
