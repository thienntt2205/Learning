...
function processButtonClick() {
	...
	case "btn_PopUp_InvoiceNo":
    	ComOpenPopup("FNS_JOO_0110.do?pgmNo=FNS_JOO_0110&inv_no="+formObj.inv_no.value, 620, 450, "setPopData_InvoiceNo", '1,0', true);
		break;
    ...
    switch(sAction) {
       case IBSEARCH:      //retrieve
            ...
            formObj.f_cmd.value=SEARCH;
 			var sXml=sheetObj.GetSearchData("FNS_JOO_0109GS.do", FormQueryString(formObj));
...
function getRdOpen() {
	...
	//var param = "/rv "+ " NgmSsoName [JSESSIONID] NgmSsoData ["+ document.form.jsession.value + "] "+"val_inv_no["+formObj.inv_no.value+"] combo_rlane_cd["+combo_rlane_cd+"] combo_itm_cd["+combo_itm_cd+"] chk_vvd["+formObj.chk_vvd.checked+"] chk_f_mm["+formObj.chk_f_mm.checked+"] chk_f_yyyy["+formObj.chk_f_yyyy.checked+"] chk_f_q["+formObj.chk_f_q.checked+"] chk_l_mm["+formObj.chk_l_mm.checked+"] chk_l_yyyy["+formObj.chk_l_yyyy.checked+"] chk_l_q["+formObj.chk_l_q.checked+"] chk_rmk["+formObj.chk_rmk.checked+"]";
	...
	var mrdpath=RD_path + "apps/opus/fns/joo/jointoperationagreementsettlement/renewalconsultation/report/FNS_JOO_0109.mrd";
	viewer.openFile(mrdpath, RDServer + param, {timeout:1800});
	
	//viewer.openFile(strPath,  param, {timeout:3000});
