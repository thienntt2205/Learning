...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0042Event"%>
		...
		<table style="width:979px">
			<tbody>
				...
				<tr>
					<th>Period</th>
					<td>
                        <input type="text" style="width:60px;text-align:center" class="input1" dataformat="ym" maxlength="6" value="<%=yyyyMM %>" caption="Period From Month" required="" fullfill="" name="acct_yrmon_fr" cofield="acct_yrmon_to" id="acct_yrmon_fr" /><!-- 
						...
						--><input type="text" style="width:60px;text-align:center" class="input1"   required fullfill maxlength='6'  caption='Period To Month'  value="<%=yyyyMM %>" dataformat='ym' name='acct_yrmon_to' id='acct_yrmon_to'   cofield="acct_yrmon_fr"><!-- 
