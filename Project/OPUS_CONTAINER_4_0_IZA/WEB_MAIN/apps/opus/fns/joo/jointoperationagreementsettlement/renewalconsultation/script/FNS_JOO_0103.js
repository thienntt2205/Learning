...
function initSheet(sheetObj, sheetNo) {
    ...
    switch (sheetObj.id) {
        case "sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                var HeadTitle1="|Grp No|CHK|Invoice No|Partner|Customer/S.Provider|Customer/S.Provider|Curr.|Rev\nExp|Amount|Effective\nDate|Due Date|Description";
                    HeadTitle1+="|||||||||||||||";//15개
                    HeadTitle1+="|||||";//5개
                var HeadTitle2="|Grp No|CHK|Invoice No|Partner|Code|Name|Curr.|Rev\nExp|Amount|Effective\nDate|Due Date|Description";
                    HeadTitle2+="|||||||||||||||";//15개
                    HeadTitle2+="|||||";//5개
