...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.renewalconsultation.event.FnsJoo0206Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0206Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0206Event)request.getAttribute("Event");
...
<input type="hidden" name="thea_stl_flg" id="thea_stl_flg" value="Y"/>
<!-- page_title_area(S) -->
<div class="page_title_area clear">
	...
	<div class="opus_design_btn"><!-- 
		...
		--><button type="button" class="btn_normal" name="btn_Invoice" 		    id="btn_Invoice">Create Invoice</button>
	</div>
	<!-- opus_design_btn(E) -->
