...
/**
 * @extends 
 * @class fns_joo_0055 : business script for fns_joo_0055
 */
...
// ComClearSeparator(ComGetEvent());         
     ...
     */
     function setSlanCdYn(){
    	 ...
    	 var sXml=sheetObjects[0].GetSearchData("FNS_JOO_0055GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
        ...
        switch(sheetNo) {
            case 1:      // sheet1 init
                ...
                var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"Status" },
                       {Type:"Text",      Hidden:0,  Width:65,   Align:"Center",  ColMerge:0,   SaveName:prefix+"slan_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       ...
                       {Type:"Text",      Hidden:0,  Width:55,   Align:"Center",  ColMerge:0,   SaveName:prefix+"voy_no",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:prefix+"dir_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:prefix+"clpt_seq",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:prefix+"port_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       ...
                       {Type:"Text",      Hidden:0,  Width:60,   Align:"Center",  ColMerge:0,   SaveName:prefix+"region",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			...
			case IBSEARCH:      //retrieve
	             if (validateForm(sheetObj, formObj, sAction)){
	                 if ( sheetObj.id == "sheet1"){
		    			...
		    			var sXml=sheetObj.GetSearchData("FNS_JOO_0055GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
