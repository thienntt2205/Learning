...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.jointoperationaccrualcreation.event.FnsJoo003402Event"%>
	...
	<div class= "opus_design_inquiry">
		<table style="width:979px">
			<tbody>
			    ...
			    <tr>
					<th>Accrual Month</th>
					<td><input type="text" style="width:60px;" required="" caption="Estimated Period" dataformat="ym" maxlength="6" value="<%=yyyyMM %>" name="exe_yrmon" class="input1" id="exe_yrmon" /><!-- 
                    ...
                    <td align="left"> ( Comparing BSA with Accrual(Result) )</td>
			    </tr> 
			</tbody>
		</table>
		...
		<tr>
			<th title="Vessel Voyage Direction">VVD</th>
             <td>&nbsp;&nbsp;<input type="radio" value="curr" name="yrmon_type" class="trans" checked="" id="yrmon_type" />&nbsp;&nbsp;Current&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- 
              	--><input type="radio" value="prev" name="yrmon_type" class="trans" id="yrmon_type" />&nbsp;&nbsp;Previous
             </td>
		</tr>
		</table>
	</div>
