...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.jointoperationconsultation.event.FnsJoo0020Event"%>
...
<input type="hidden" name="re_divr_cd" value="R" id="re_divr_cd" />
<input type="hidden" name="ar_ap_div_cd" value="R" id="ar_ap_div_cd" />
<input type="hidden" name="slp_tp_cd" value="18" id="slp_tp_cd" />
...
<input type="hidden" name="com_mrdTitle" value="Transfer Slip" id="com_mrdTitle" />
<input type="hidden" name="com_mrdBodyTitle" value="Transfer Slip" id="com_mrdBodyTitle" />
...
<input type="hidden" name="com_mrdSaveDialogFileName" value="Transfer Slip" id="com_mrdSaveDialogFileName" />
		...
		<table style="width:979px">
			<tbody>
			    ...
			    <tr>
					<th>Account Month</th>
					<td>
						<input type="text" style="width:60px;" class="input1" name="acct_yrmon" value="<%=yyyyMM%>" dataformat="ym" maxlength="6" id="acct_yrmon" /><!-- 
					...
					<th>CSR No.</th>
					<td><input type="text" style="width:194px;" class="input2" name="csr_no" id="csr_no" /> </td>
				</tr>
	...
	<div class= "opus_design_inquiry">	
		<table>
			<tbody>
				...
				<tr>
					<th>Customer Code</th>
					<td><input type="text" style="width:30px;" class="input2" name="cust_vndr_cnt_cd" readonly id="cust_vndr_cnt_cd" /><input type="text" style="width:90px;" class="input2" name="cust_vndr_seq" readonly id="cust_vndr_seq" /></td>
					<th>Customer Name(Local)</th>
					<td><input type="text" style="width:348px;" class="input2" name="cust_vndr_kor_nm" readonly id="cust_vndr_kor_nm" /></td>
				</tr> 
				<tr>
					...
					<td><input type="text" style="width:348px;" class="input2" name="cust_vndr_eng_nm" readonly id="cust_vndr_eng_nm" /></td>
				</tr> 	
			</tbody>	
		</table>
		...
		<table>
			<tbody>
				...
				<tr>
						...
						<th>Issue Date</th>
						<td><input type="text" style="width:75px;text-align:center" class="input2" name="slp_iss_dt" value="<%=yyyyMMdd%>" dataformat="ymd" maxlength="8" readonly id="slp_iss_dt" /></td>
						<th>Issuer</th>
						<td colspan="3"><input type="text" style="width:188px;text-align:left" class="input2" name="issuer_nm" value="<%=strUsr_nm%>" readonly id="issuer_nm" /> </td>
				</tr> 
				<tr>
						<th>Description</th>
						<td colspan="7"><input type="text" style="width:667px;" class="input1" name="csr_desc" maxlength="50" id="csr_desc" /> </td>
				</tr> 
				<tr>
						<th>Currency</th>
						...
						<th>Eff. Date</th>
						<td><input type="text" style="width:90px;text-align:center" class="input1" name="eff_dt" dataformat="ymd" maxlength="8" id="eff_dt" /><button type="button" id="btn_eff" name="btn_eff" class="calendar ir"></button></td>
						<th>DUE Date</th>
						<td><input type="text" style="width:90px;text-align:center" class="input1" name="rqst_dt" dataformat="ymd" maxlength="8" id="rqst_dt" /><button type="button" id="btn_rqst" name="btn_rqst" class="calendar ir"></button></td>
				</tr>
