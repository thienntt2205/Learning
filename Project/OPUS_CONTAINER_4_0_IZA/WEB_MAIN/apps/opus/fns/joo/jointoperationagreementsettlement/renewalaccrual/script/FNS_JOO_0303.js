...
/**
 * @extends 
 * @class fns_joo_0303 : business script for ui_joo_0303
 */
    function fns_joo_0303() {
    	...
    	case IBSEARCH: //retrieve
    		if (validateForm(sheetObj, formObj, sAction)){
    			formObj.f_cmd.value=SEARCH;
     			sheetObj.DoSearch("FNS_JOO_0303GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix) );
    		}
    		break;
    	case IBSAVE: //save 
    		if (validateForm(sheetObj, formObj, sAction)){ 
    			...
    			var aryPrefix=new Array("sheet1_");	//prefix character array	
     			var sXml=sheetObj.GetSaveData("FNS_JOO_0303GS.do", SaveStr + "&" + FormQueryString(formObj) + "&" + ComGetPrefixParam(aryPrefix));
