...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.renewalconsultation.event.FnsJoo0210Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0210Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0210Event)request.getAttribute("Event");
