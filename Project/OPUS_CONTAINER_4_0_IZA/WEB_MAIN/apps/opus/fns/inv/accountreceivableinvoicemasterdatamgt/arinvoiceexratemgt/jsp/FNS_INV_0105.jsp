...
<%@ page import="com.clt.apps.opus.fns.inv.accountreceivableinvoicemasterdatamgt.arinvoiceexratemgt.event.FnsInv0105Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0105Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0105Event)request.getAttribute("Event");
...
<div class="page_title_area clear ">
	...
	<!-- page_title(E) -->
	    ...
	    --><button type="button" class="btn_accent" name="btn1_History" id="btn1_History">History</button><!--
	...
	<div class="opus_design_inquiry wFit">
				<table>
					...
					<tr>
						...
						<td><input type="text" dataformat="engup" value="" name="vvd_cd" id="vvd_cd" style="width: 80px" class="input1" maxlength="9"></td>
						...
						<th>Office</th>
						<td><script type="text/javascript">ComComboObject('ar_ofc_cd', 1, 100, 0);</script>
						</td>
					</tr>
				</table>
		<!--biz page (S)-->
...
<!-- opus_design_grid(S) -->
	<div class="opus_design_grid" id="mainTable">		
	    ...
	    <div class="opus_design_btn">
			...
			--><button type="button" class="btn_normal" name="btn2_Del" id="btn2_Del">Delete</button></div>
	    <!-- opus_design_btn(E) -->
