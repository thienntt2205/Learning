...
*@FileName : SetupCreationDBDAOAddPartnerPortLaneCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOAddPartnerPortLaneCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 EDI PARTNER PORT LANE 정보를 신규 입력한다
	  * </pre>
	  */
	public SetupCreationDBDAOAddPartnerPortLaneCSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOAddPartnerPortLaneCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
