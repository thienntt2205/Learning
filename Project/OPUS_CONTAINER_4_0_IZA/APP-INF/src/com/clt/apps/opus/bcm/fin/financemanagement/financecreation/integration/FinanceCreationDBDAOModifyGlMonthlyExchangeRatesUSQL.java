...
*@FileName : FinanceCreationDBDAOModifyGlMonthlyExchangeRatesUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAOModifyGlMonthlyExchangeRatesUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyGlMonthlyExchangeRates
	  * </pre>
	  */
	public FinanceCreationDBDAOModifyGlMonthlyExchangeRatesUSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAOModifyGlMonthlyExchangeRatesUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", USD_LOCL_XCH_RT = @[usd_locl_xch_rt]" ).append("\n"); 
		query.append(", LOCL_CNY_XCH_RT = @[locl_cny_xch_rt]" ).append("\n"); 
		query.append(", USD_CNY_XCH_RT = @[usd_cny_xch_rt]" ).append("\n"); 
