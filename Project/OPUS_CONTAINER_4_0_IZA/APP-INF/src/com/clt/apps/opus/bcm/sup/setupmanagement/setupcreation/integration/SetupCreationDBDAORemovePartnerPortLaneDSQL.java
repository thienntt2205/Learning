...
*@FileName : SetupCreationDBDAORemovePartnerPortLaneDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAORemovePartnerPortLaneDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 EDI PARTNER PORT LANE 정보를 삭제한다
	  * </pre>
	  */
	public SetupCreationDBDAORemovePartnerPortLaneDSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAORemovePartnerPortLaneDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
