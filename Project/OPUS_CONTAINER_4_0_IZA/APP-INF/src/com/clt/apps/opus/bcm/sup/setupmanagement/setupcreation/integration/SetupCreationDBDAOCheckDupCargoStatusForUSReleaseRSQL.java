...
*@FileName : SetupCreationDBDAOCheckDupCargoStatusForUSReleaseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOCheckDupCargoStatusForUSReleaseRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cargo Tracking Info.(Non physical event for US cargo release)에 중복데이타가 존재하는지 체크한다
	  * </pre>
	  */
	public SetupCreationDBDAOCheckDupCargoStatusForUSReleaseRSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOCheckDupCargoStatusForUSReleaseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
