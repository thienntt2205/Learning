...
*@FileName : FinanceCreationDBDAORemoveGlDailyExchangeRatesDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAORemoveGlDailyExchangeRatesDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveGlDailyExchangeRates
	  * </pre>
	  */
	public FinanceCreationDBDAORemoveGlDailyExchangeRatesDSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAORemoveGlDailyExchangeRatesDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
