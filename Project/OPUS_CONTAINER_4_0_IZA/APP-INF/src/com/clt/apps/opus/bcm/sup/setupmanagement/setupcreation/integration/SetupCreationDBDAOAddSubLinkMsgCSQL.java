...
*@FileName : SetupCreationDBDAOAddSubLinkMsgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOAddSubLinkMsgCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 BKG EDI SUB LNK MSG 정보를 신규 입력한다
	  * </pre>
	  */
	public SetupCreationDBDAOAddSubLinkMsgCSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOAddSubLinkMsgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
