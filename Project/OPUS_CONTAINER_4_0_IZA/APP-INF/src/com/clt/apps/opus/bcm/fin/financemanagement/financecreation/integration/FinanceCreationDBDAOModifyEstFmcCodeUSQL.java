 ...
 *@FileName : FinanceCreationDBDAOModifyEstFmcCodeUSQL.java
 *@FileTitle : 
 *Open Issues :
 *Change history :
...
public class FinanceCreationDBDAOModifyEstFmcCodeUSQL implements ISQLTemplate {
	 ...
	 * </pre>
	 */
	public FinanceCreationDBDAOModifyEstFmcCodeUSQL() {
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyEstFmcCodeUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery() {
		query.append("UPDATE GL_FMC_ENT").append("\n");
