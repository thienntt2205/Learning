...
*@FileName : BCM_SUP_0006HTMLAction.java
*@FileTitle : EDI YARD
*Open Issues :
*Change history :
 ...
 * @see BcmSup0006Event 참조
 * @since J2EE 1.6
 */

public class BCM_SUP_0006HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * BCM_SUP_0006HTMLAction 객체를 생성
	 */
	public BCM_SUP_0006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmSup0006Event event = new BcmSup0006Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchYardListVOS((SearchYardListVO[])getVOs(request, SearchYardListVO.class,""));

			event.setYardCode(request.getParameter("s_yd_cd"));
