...
*@FileName : FinanceCreationDBDAOModifyGlEstimateRevenueVvdsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAOModifyGlEstimateRevenueVvdsUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyGlEstimateRevenueVvds
	  * </pre>
	  */
	public FinanceCreationDBDAOModifyGlEstimateRevenueVvdsUSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAOModifyGlEstimateRevenueVvdsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", ESTM_VVD_TP_CD = @[estm_vvd_tp_cd]" ).append("\n"); 
		query.append(", ESTM_IOC_DIV_CD = @[estm_ioc_div_cd]" ).append("\n"); 
		query.append(", ESTM_VVD_HDR_ID = @[estm_vvd_hdr_id]" ).append("\n"); 
