...
*@FileName : SetupCreationDBDAORemoveGroupDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAORemoveGroupDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.17 정윤태 EDI GROUP 정보를 삭제한다
	  * </pre>
	  */
	public SetupCreationDBDAORemoveGroupDSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAORemoveGroupDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
