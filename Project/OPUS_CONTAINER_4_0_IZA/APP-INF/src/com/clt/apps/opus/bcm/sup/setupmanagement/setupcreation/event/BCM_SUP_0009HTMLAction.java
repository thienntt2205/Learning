...
*@FileName : BCM_SUP_0009HTMLAction.java
 ...
 * @see BcmSup0009Event 참조
 * @since J2EE 1.6
 */

public class BCM_SUP_0009HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * BCM_SUP_0009HTMLAction 객체를 생성
	 */
	public BCM_SUP_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmSup0009Event event = new BcmSup0009Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCargoStatusForUSReleaseVOS((CargoStatusForUSReleaseVO[])getVOs(request, CargoStatusForUSReleaseVO.class,""));
			event.setEdiOrgStsCd(request.getParameter("s_edi_org_sts_cd"));
