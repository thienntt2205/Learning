...
*@FileName : SetupCreationDBDAORemoveGroupCargoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAORemoveGroupCargoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.23 정윤태 EDI GROUP CARGO 정보를 삭제한다
	  * </pre>
	  */
	public SetupCreationDBDAORemoveGroupCargoDSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAORemoveGroupCargoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND EDI_STND_STS_CD = @[edi_stnd_sts_cd]" ).append("\n"); 
