...
*@FileName : SetupCreationDBDAOModifyPartnerPortLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOModifyPartnerPortLaneUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 EDI PARTNER PORT LANE 정보를 변경한다
	  * </pre>
	  */
	public SetupCreationDBDAOModifyPartnerPortLaneUSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOModifyPartnerPortLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
