...
*@FileName : SetupCreationDBDAOModifyGroupCargoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOModifyGroupCargoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.23 정윤태 EDI GROUP CARGO 정보를 변경한다
	  * </pre>
	  */
	public SetupCreationDBDAOModifyGroupCargoUSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOModifyGroupCargoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET CUST_EDI_STS_CD = @[cust_edi_sts_cd]," ).append("\n"); 
		...
		query.append("       EDI_SND_ITVAL_HRMNT = @[edi_snd_itval_hrmnt]," ).append("\n"); 
