...
*@FileName : FinanceCreationDBDAOModifyApPeriodUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAOModifyApPeriodUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.18 정윤태 AP PERIOD 정보를 변경한다
	  * </pre>
	  */
	public FinanceCreationDBDAOModifyApPeriodUSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAOModifyApPeriodUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AP_PERIOD" ).append("\n"); 
		query.append("   SET CLZ_STS_CD = @[clz_sts_cd]," ).append("\n"); 
		query.append("       SYS_DESC = @[sys_desc]," ).append("\n"); 
		query.append("       RHQ_CD = @[rhq_cd]," ).append("\n"); 
		query.append("       UPD_USR_ID = @[upd_usr_id]," ).append("\n"); 
		query.append("       LST_UPD_DT = SYSDATE" ).append("\n"); 
