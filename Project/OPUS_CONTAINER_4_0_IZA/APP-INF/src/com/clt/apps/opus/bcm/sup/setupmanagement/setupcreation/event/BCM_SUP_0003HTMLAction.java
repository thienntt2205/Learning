...
*@FileName : BCM_SUP_0003HTMLAction.java
 ...
 * @see BcmSup0003Event 참조
 * @since J2EE 1.6
 */

public class BCM_SUP_0003HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * BCM_SUP_0003HTMLAction 객체를 생성
	 */
	public BCM_SUP_0003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmSup0003Event event = new BcmSup0003Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchGroupCargoListVOS((SearchGroupCargoListVO[])getVOs(request, SearchGroupCargoListVO.class,""));
			...
			event.setStndStsCd(request.getParameter("edi_stnd_sts_cd"));
