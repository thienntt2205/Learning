...
*@FileName : SetupCreationDBDAOAddCargoStandardStatusCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOAddCargoStandardStatusCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.18 정윤태 EDI CARGO STANDARD STATUS 정보를 신규 입력한다
	  * </pre>
	  */
	public SetupCreationDBDAOAddCargoStandardStatusCSQL(){
		setQuery();
		...
		params.put("rpln_bat_snd_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("edi_sts_desc",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SetupCreationDBDAOAddCargoStandardStatusCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
