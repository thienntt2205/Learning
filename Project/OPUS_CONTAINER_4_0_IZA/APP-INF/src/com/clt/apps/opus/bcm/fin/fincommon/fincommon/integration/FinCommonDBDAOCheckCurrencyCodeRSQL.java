...
*@FileName : FinCommonDBDAOCheckCurrencyCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinCommonDBDAOCheckCurrencyCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FinCommonDBDAOCheckCurrencyCodeRSQL(){
		setQuery();
		...
		query.append("FileName : FinCommonDBDAOCheckCurrencyCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
