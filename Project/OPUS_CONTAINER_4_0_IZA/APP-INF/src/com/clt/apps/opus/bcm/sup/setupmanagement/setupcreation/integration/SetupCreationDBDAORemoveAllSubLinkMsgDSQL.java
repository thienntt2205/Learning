...
*@FileName : SetupCreationDBDAORemoveAllSubLinkMsgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAORemoveAllSubLinkMsgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 EDI TRADE PARTNER SUB LINK 정보에 해당하는 BKG EDI SUB LNK MSG 정보 전체를 삭제한다
	  * </pre>
	  */
	public SetupCreationDBDAORemoveAllSubLinkMsgDSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAORemoveAllSubLinkMsgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
