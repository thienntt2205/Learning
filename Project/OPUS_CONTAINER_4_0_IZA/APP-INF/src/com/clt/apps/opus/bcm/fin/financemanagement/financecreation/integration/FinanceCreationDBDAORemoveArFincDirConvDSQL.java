...
*@FileName : FinanceCreationDBDAORemoveArFincDirConvDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAORemoveArFincDirConvDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AR_FINC_DIR_CONV table에 정보 삭제
	  * </pre>
	  */
	public FinanceCreationDBDAORemoveArFincDirConvDSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAORemoveArFincDirConvDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
