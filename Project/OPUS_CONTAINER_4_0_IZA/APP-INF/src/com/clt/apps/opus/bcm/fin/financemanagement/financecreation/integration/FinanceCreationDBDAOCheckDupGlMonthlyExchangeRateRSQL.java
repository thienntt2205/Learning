...
*@FileName : FinanceCreationDBDAOCheckDupGlMonthlyExchangeRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAOCheckDupGlMonthlyExchangeRateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CheckDupGlMonthlyExchangeRate
	  * </pre>
	  */
	public FinanceCreationDBDAOCheckDupGlMonthlyExchangeRateRSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAOCheckDupGlMonthlyExchangeRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
