...
*@FileName : FinanceCreationDBDAOAddApPeriodCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FinanceCreationDBDAOAddApPeriodCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.18 정윤태 AP PERIOD 정보를 신규 입력한다
	  * </pre>
	  */
	public FinanceCreationDBDAOAddApPeriodCSQL(){
		setQuery();
		...
		query.append("FileName : FinanceCreationDBDAOAddApPeriodCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
