...
*@FileName : SetupCreationDBDAORemoveCargoStatusForCustomerDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAORemoveCargoStatusForCustomerDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cargo Tracking Info.(Non physical event for customer) 정보를 삭제한다
	  * </pre>
	  */
	public SetupCreationDBDAORemoveCargoStatusForCustomerDSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAORemoveCargoStatusForCustomerDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCE_EDI_MNG_STS" ).append("\n"); 
