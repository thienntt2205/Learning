...
*@FileName : SetupCreationDBDAOModifyTradePartnerSubLinkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupCreationDBDAOModifyTradePartnerSubLinkUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.07 정윤태 EDI TRADE PARTNER SUB LINK 정보를 변경한다
	  * </pre>
	  */
	public SetupCreationDBDAOModifyTradePartnerSubLinkUSQL(){
		setQuery();
		...
		query.append("FileName : SetupCreationDBDAOModifyTradePartnerSubLinkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET PRNR_SUB_LNK_DIV_CD = @[prnr_sub_lnk_div_cd]," ).append("\n"); 
		query.append("       PRNR_SUB_LNK_CD = @[prnr_sub_lnk_cd]," ).append("\n"); 
		query.append("       SNDR_TRD_PRNR_ID = @[sndr_trd_prnr_id]," ).append("\n"); 
		query.append("       RCVR_TRD_PRNR_ID = @[rcvr_trd_prnr_id]," ).append("\n"); 
		query.append("       PRNR_PORT_CD = @[prnr_port_cd]," ).append("\n"); 
		query.append("       EDI_SND_FLG = @[edi_snd_flg]," ).append("\n"); 
