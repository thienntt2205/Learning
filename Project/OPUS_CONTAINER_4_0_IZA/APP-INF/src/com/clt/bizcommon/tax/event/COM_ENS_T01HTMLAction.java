...
*@FileName : COM_ENS_T01HTMLAction.java
*@FileTitle : Subtrade
*Open Issues :
*Change history :
 ...
 * @see ComEnsT01Event 참조
 * @since J2EE 1.4
 */
public class COM_ENS_T01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_ENS_T01HTMLAction 객체를 생성
	 */
	public COM_ENS_T01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComEnsT01Event event = new ComEnsT01Event();
		event.setComTaxVO((ComTaxVO)getVO(request, ComTaxVO.class));
