...
public class COM_ENS_061HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	String mdm_yn = JSPUtil.getParameter(request, "mdm_yn", "");
    	String delt_flg = "";
    	if("Y".equals(mdm_yn)){
    		delt_flg = JSPUtil.getParameter(request, "delt_flg", "N");
    	}else{
    		delt_flg = JSPUtil.getParameter(request, "delt_flg", "");
    	}
    	...
    	ComEns061Event event = new ComEns061Event(cnt_cd, loc_cd, ofc_cd, node_cd, node_nm, mode, mode_only, scc_cd,iPage,mdm_yn, delt_flg);
