 ...
 *
 * @author Kim Yong Jin
 * @see ComCom0008Event , COM_COM_0008EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_COM_0008HTMLAction extends HTMLActionSupport {

	/**
	 * COM_COM_0008HTMLAction 객체를 생성
	 */
	public COM_COM_0008HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_COM_0008Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ComCom0008Event event = new ComCom0008Event();
    	
    	event.setSalesRepListVO((SalesRepListVO)getVO(request, SalesRepListVO .class));
