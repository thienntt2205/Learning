...
*@FileName : ConsultationSlipRequestMgtDBDAOModifySoPayInvoiceInterfaceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOModifySoPayInvoiceInterfaceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySoPayInvoiceInterface
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOModifySoPayInvoiceInterfaceUSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOModifySoPayInvoiceInterfaceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
