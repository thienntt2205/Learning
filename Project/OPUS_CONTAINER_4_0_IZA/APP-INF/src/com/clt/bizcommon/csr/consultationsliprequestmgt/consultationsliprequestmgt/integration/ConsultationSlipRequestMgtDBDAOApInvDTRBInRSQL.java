...
public class ConsultationSlipRequestMgtDBDAOApInvDTRBInRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                         NVL(D.PORT_CD, ( SELECT LOC_CD FROM MDM_ORGANIZATION WHERE OFC_CD = H.COST_OFC_CD ))                      ATTR_CTNT3," ).append("\n"); 
		...
		query.append("                         DECODE(D.ACCT_CD,COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','ACCT_RCV_JNT_OPER'),NULL" ).append("\n"); 
		query.append("							   ,COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','LEGY_SYS_CLEARING'),NULL" ).append("\n"); 
		query.append("							   ,COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','BANK_CMMS'),NULL,D.ACT_VVD_CD)				   ACT_VVD_CD," ).append("\n"); 
		query.append("                         'C'                                                                      PLN_SCTR_DIV_CD," ).append("\n"); 
		query.append("                         NULL                                                                     SO_CRR_CD," ).append("\n"); 
		query.append("                         D.YD_CD                                                                  YD_CD," ).append("\n"); 
		query.append("                         DECODE(D.ACCT_CD,COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','ACCT_RCV_JNT_OPER'),NULL,D.LGS_COST_CD) FTU_USE_CTNT1," ).append("\n"); 
		query.append("                         DECODE(D.ACCT_CD,COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','ACCT_RCV_JNT_OPER'),NULL,DECODE(H.INV_SUB_SYS_CD,'PSO',NULL," ).append("\n"); 
		...
		query.append("                        ( SELECT ACCT_ENG_NM" ).append("\n"); 
		query.append("                            FROM    MDM_ACCOUNT" ).append("\n"); 
		query.append("                           WHERE   ACCT_CD = DECODE(SIGN(H.WHLD_TAX_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','WTHD_TAX_CLEARING'), ''))   INV_DESC," ).append("\n"); 
		...
		query.append("                           WHERE  OFC_CD = H.COST_OFC_CD )                                        DTRB_COA_CTR_CD," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                         DECODE(SIGN(H.WHLD_TAX_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','WTHD_TAX_CLEARING'), '')						DTRB_COA_ACCT_CD," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                         '0000000000'                                                             DTRB_COA_VVD_CD," ).append("\n"); 
		query.append("                         '00'                                                                     DTRB_COA_INTER_CO_CD," ).append("\n"); 
		query.append("                         DECODE(SIGN(H.WHLD_TAX_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','WTHD_TAX_CLEARING'), '')                        ATTR_CATE_NM," ).append("\n"); 
		query.append("                         H.INV_NO                                                                 ATTR_CTNT1," ).append("\n"); 
		query.append("                         TO_CHAR(H.INV_ISS_DT,'YYYY/MM/DD HH24:MI:SS')                            ATTR_CTNT2," ).append("\n"); 
		...
		query.append("                                 AND D.DELT_FLG    = 'N'" ).append("\n"); 
		query.append("                                 AND ROWNUM = 1), ( SELECT LOC_CD FROM MDM_ORGANIZATION WHERE OFC_CD = H.COST_OFC_CD ))  	  	ATTR_CTNT3," ).append("\n"); 
		...
		query.append("                        ( SELECT ACCT_ENG_NM" ).append("\n"); 
		query.append("                            FROM    MDM_ACCOUNT" ).append("\n"); 
		query.append("                           WHERE   ACCT_CD = DECODE(SIGN(H.INV_VAT_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','PREPAID_VAT_HQ'), '')) INV_DESC," ).append("\n"); 
		...
		query.append("                           WHERE  OFC_CD = H.COST_OFC_CD )                                        DTRB_COA_CTR_CD," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                         DECODE(SIGN(H.INV_VAT_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','PREPAID_VAT_HQ'), '')                      DTRB_COA_ACCT_CD," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                         '0000000000'                                                             DTRB_COA_VVD_CD," ).append("\n"); 
		query.append("                         '00'                                                                     DTRB_COA_INTER_CO_CD," ).append("\n"); 
		query.append("                         DECODE(SIGN(H.INV_VAT_AMT), 1, COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','PREPAID_VAT_HQ'), '')                      ATTR_CATE_NM," ).append("\n"); 
		query.append("                         H.INV_NO                                                                   ATTR_CTNT1," ).append("\n"); 
		query.append("                         TO_CHAR(H.INV_ISS_DT,'YYYY/MM/DD HH24:MI:SS')                              ATTR_CTNT2," ).append("\n"); 
		query.append("                         NVL((SELECT D.PORT_CD" ).append("\n"); 
		query.append("                                FROM AP_PAY_INV_DTL D" ).append("\n"); 
		...
		query.append("                             ORDER BY B.INV_RGST_NO, B.INV_RGST_SEQ DESC" ).append("\n"); 
		query.append("                             FETCH FIRST 1 ROWS ONLY" ).append("\n"); 
		query.append("		                     )" ).append("\n"); 
		query.append("		             ) INV_DESC                ," ).append("\n"); 
		...
		query.append("		             WHERE   OFC_CD = H.COST_OFC_CD" ).append("\n"); 
		query.append("		             ) DTRB_COA_CTR_CD           ," ).append("\n"); 
		query.append("		             COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','ACCT_RCV_NONGVT_AGN') DTRB_COA_ACCT_CD   ," ).append("\n"); 
		query.append("		             '0000000000' DTRB_COA_VVD_CD," ).append("\n"); 
		query.append("		             ( SELECT NVL(SUBS_CO_CD,'00')" ).append("\n"); 
		query.append("		             FROM    MDM_VENDOR" ).append("\n"); 
		query.append("		             WHERE   VNDR_SEQ = H.VNDR_SEQ" ).append("\n"); 
		query.append("		             ) DTRB_COA_INTER_CO_CD                                  ," ).append("\n"); 
		query.append("		             COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','ACCT_RCV_NONGVT_AGN') ATTR_CATE_NM," ).append("\n"); 
		query.append("		             H.INV_NO ATTR_CTNT1                                     ," ).append("\n"); 
		query.append("		             TO_CHAR(H.INV_ISS_DT,'YYYY/MM/DD HH24:MI:SS') ATTR_CTNT2," ).append("\n"); 
		query.append("                 NVL((SELECT D.PORT_CD" ).append("\n"); 
		query.append("                        FROM AP_PAY_INV_DTL D" ).append("\n"); 
		...
		query.append("		             ( SELECT ACCT_ENG_NM" ).append("\n"); 
		query.append("		             FROM    MDM_ACCOUNT" ).append("\n"); 
		query.append("		             WHERE   ACCT_CD = COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','AGT_ACCT_RCV')" ).append("\n"); 
		query.append("		             ) INV_DESC                ," ).append("\n"); 
		query.append("		             -( H.INV_TTL_AMT ) INV_AMT," ).append("\n"); 
		query.append("		             ( SELECT FINC_RGN_CD" ).append("\n"); 
		query.append("		             FROM    MDM_ORGANIZATION" ).append("\n"); 
		...
		query.append("		             WHERE   OFC_CD = H.COST_OFC_CD" ).append("\n"); 
		query.append("		             ) DTRB_COA_CTR_CD," ).append("\n"); 
		query.append("		             COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','AGT_ACCT_RCV') DTRB_COA_ACCT_CD," ).append("\n"); 
		query.append("		             '0000000000' DTRB_COA_VVD_CD," ).append("\n"); 
		query.append("		             ( SELECT NVL(SUBS_CO_CD,'00')" ).append("\n"); 
		query.append("		             FROM    MDM_VENDOR" ).append("\n"); 
		query.append("		             WHERE   VNDR_SEQ = H.VNDR_SEQ" ).append("\n"); 
		query.append("		             ) DTRB_COA_INTER_CO_CD," ).append("\n"); 
		query.append("		             COM_CSR_GET_ACCT_HRD_CDG_FNC('CSR','AGT_ACCT_RCV') ATTR_CATE_NM," ).append("\n"); 
		query.append("		             H.INV_NO ATTR_CTNT1                                     ," ).append("\n"); 
		query.append("		             TO_CHAR(H.INV_ISS_DT,'YYYY/MM/DD HH24:MI:SS') ATTR_CTNT2," ).append("\n"); 
		query.append("                 NVL((SELECT D.PORT_CD" ).append("\n"); 
		query.append("                        FROM AP_PAY_INV_DTL D" ).append("\n"); 
