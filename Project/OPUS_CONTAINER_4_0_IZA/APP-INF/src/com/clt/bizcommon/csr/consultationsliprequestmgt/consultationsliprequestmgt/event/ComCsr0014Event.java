...
public class ComCsr0014Event extends EventSupport {
	...
	/**
	 * @param payInvs the payInvs to set
	 */
	public void setPayInvs(Collection payInvs) {
		this.payInvs = payInvs;
	}
	...
	public String[] getChks() {
		String[] rtnVOs = null;
		if (this.chks != null) {
			rtnVOs = new String[chks.length];
			System.arraycopy(chks, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setChks(String[] chks) {
		if (chks != null) {
			String[] tmpVOs = new String[chks.length];
			System.arraycopy(chks, 0, tmpVOs, 0, tmpVOs.length);
			this.chks = tmpVOs;
		}
	}
