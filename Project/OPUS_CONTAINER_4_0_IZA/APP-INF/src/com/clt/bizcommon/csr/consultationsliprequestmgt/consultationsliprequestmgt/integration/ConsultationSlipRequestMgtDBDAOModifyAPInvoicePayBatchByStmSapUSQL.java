...
*@FileName : ConsultationSlipRequestMgtDBDAOModifyAPInvoicePayBatchByStmSapUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOModifyAPInvoicePayBatchByStmSapUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOModifyAPInvoicePayBatchByStmSapUSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOModifyAPInvoicePayBatchByStmSapUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE   A.CSR_NO IN (" ).append("\n"); 
