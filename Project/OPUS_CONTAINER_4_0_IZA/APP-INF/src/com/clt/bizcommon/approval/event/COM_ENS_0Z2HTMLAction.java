...
*@FileName : COM_ENS_0Z2HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - COM_ENS_0Z2 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author YoNa Ha
 * @see ComEns0Z2Event 참조
 * @since J2EE 1.4
 */

public class COM_ENS_0Z2HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_ENS_0Z2HTMLAction 객체를 생성
	 */
	public COM_ENS_0Z2HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ComEns0Z2Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComEns0Z2Event event = new ComEns0Z2Event();
