...
/**
 * COM_ENS_0Z1 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - COM_ENS_0Z1HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author YoNa Ha
 * @see COM_ENS_0Z1HTMLAction 참조
 * @since J2EE 1.4
 */

public class ComEns0Z1Event extends EventSupport {
