...
*@FileName : ApprovalDBDAOsearchApprovalRouteUtilList2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOsearchApprovalRouteUtilList2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchApprovalRouteUtilList2
	  * </pre>
	  */
	public ApprovalDBDAOsearchApprovalRouteUtilList2RSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOsearchApprovalRouteUtilList2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
