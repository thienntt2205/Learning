 ...
 * @since J2EE 1.4
 */
public class COM_COM_0001HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0N1HTMLAction 객체를 생성
	 */
	public COM_COM_0001HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ComCom0001Event event = new ComCom0001Event(iPage);
    	
		event.setChargeListVO((ChargeListVO)getVO(request, ChargeListVO .class));
