...
*@FileName : CodeManagementDBDAOsearchDupChkCodeMgmtDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAOsearchDupChkCodeMgmtDtlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CodeManagementDBDAOsearchDupChkCodeMgmtDtlRSQL
	  * </pre>
	  */
	public CodeManagementDBDAOsearchDupChkCodeMgmtDtlRSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAOsearchDupChkCodeMgmtDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
