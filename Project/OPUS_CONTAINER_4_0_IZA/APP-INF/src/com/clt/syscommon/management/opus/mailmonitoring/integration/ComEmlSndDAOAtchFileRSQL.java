...
*@FileName : ComEmlSndDAOAtchFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ComEmlSndDAOAtchFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ComEmlSndDAOAtchFileRSQL(){
		setQuery();
		...
		query.append("FileName : ComEmlSndDAOAtchFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select * from com_eml_atch_file" ).append("\n"); 
