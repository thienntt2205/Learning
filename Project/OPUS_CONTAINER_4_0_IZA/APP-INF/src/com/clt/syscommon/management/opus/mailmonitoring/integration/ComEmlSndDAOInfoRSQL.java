...
*@FileName : ComEmlSndDAOInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ComEmlSndDAOInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * get ComEmlSndInfo table data
	  * </pre>
	  */
	public ComEmlSndDAOInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ComEmlSndDAOInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
