...
*@FileName : MqInboundMonitoringDAOSearchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MqInboundMonitoringDAOSearchRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MqInboundMonitoringDAOSearchRSQL(){
		setQuery();
		...
		params.put("msg_proc_sts_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MqInboundMonitoringDAOSearchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND MSG_PROC_STS_CD = @[msg_proc_sts_cd]" ).append("\n"); 
