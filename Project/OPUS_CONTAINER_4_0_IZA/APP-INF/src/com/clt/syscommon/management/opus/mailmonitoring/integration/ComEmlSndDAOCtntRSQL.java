...
*@FileName : ComEmlSndDAOCtntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ComEmlSndDAOCtntRSQL implements ISQLTemplate{
	...
	public ComEmlSndDAOCtntRSQL(){
		...
		query.append("FileName : ComEmlSndDAOCtntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select * from com_eml_snd_ctnt" ).append("\n"); 
