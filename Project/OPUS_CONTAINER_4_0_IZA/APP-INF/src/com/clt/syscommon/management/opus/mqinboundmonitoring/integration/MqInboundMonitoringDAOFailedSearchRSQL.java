...
*@FileName : MqInboundMonitoringDAOFailedSearchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MqInboundMonitoringDAOFailedSearchRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * It gets a data if you want to get Fail Data.
	  * </pre>
	  */
	public MqInboundMonitoringDAOFailedSearchRSQL(){
		setQuery();
		...
		query.append("FileName : MqInboundMonitoringDAOFailedSearchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND (MSG_PROC_STS_CD = 4 OR MSG_PROC_STS_CD = 6)" ).append("\n"); 
