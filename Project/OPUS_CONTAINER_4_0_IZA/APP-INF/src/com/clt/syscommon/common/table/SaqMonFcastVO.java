...
*@FileName : SaqMonFcastVO.java
*@FileTitle : SaqMonFcastVO
*Open Issues :
*Change history :
...
public class SaqMonFcastVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMonFcastVO> models = new ArrayList<SaqMonFcastVO>();
	 ...
	 * @param request
	 * @return SaqMonFcastVO[]
	 */
	public SaqMonFcastVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonFcastVO[]
	 */
	public SaqMonFcastVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMonFcastVO model = null;
	 ...
	 * @return SaqMonFcastVO[]
	 */
	public SaqMonFcastVO[] getSaqMonFcastVOs(){
		SaqMonFcastVO[] vos = (SaqMonFcastVO[])models.toArray(new SaqMonFcastVO[models.size()]);
		return vos;
	}
