...
*@FileName : SaqPerfSmryVO.java
*@FileTitle : SaqPerfSmryVO
*Open Issues :
*Change history :
...
public class SaqPerfSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqPerfSmryVO> models = new ArrayList<SaqPerfSmryVO>();
	...
	public SaqPerfSmryVO() {}

	public SaqPerfSmryVO(String ibflag, String pagerows, String bseYr, String bseMon, String trdCd, String rlaneCd, String dirCd, String ctrtRgnOfcCd, String slsRgnOfcCd, String custCntCd, String custSeq, String polCd, String podCd, String subTrdCd, String ctrtRhqCd, String ctrtAqCd, String slsRhqCd, String slsAqCd, String lodQty, String grsRpbRev, String cmUcAmt, String opfitUcAmt, String raCmUcAmt, String raStpPfitUtAmt, String raOpfitUcAmt, String cfmFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 * @param request
	 * @return SaqPerfSmryVO[]
	 */
	public SaqPerfSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqPerfSmryVO[]
	 */
	public SaqPerfSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqPerfSmryVO model = null;
	 ...
	 * @return SaqPerfSmryVO[]
	 */
	public SaqPerfSmryVO[] getSaqPerfSmryVOs(){
		SaqPerfSmryVO[] vos = (SaqPerfSmryVO[])models.toArray(new SaqPerfSmryVO[models.size()]);
		return vos;
	}
