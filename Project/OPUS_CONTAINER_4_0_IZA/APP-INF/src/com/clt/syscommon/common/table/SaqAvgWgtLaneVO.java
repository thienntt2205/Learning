...
*@FileName : SaqAvgWgtLaneVO.java
*@FileTitle : SaqAvgWgtLaneVO
*Open Issues :
*Change history :
...
public class SaqAvgWgtLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqAvgWgtLaneVO> models = new ArrayList<SaqAvgWgtLaneVO>();
	...
	public SaqAvgWgtLaneVO() {}

	public SaqAvgWgtLaneVO(String ibflag, String pagerows, String bseYr, String bseMon, String trdCd, String rlaneCd, String dirCd, String subTrdCd, String cntrAvgWgt, String initCntrAvgWgt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.trdCd = trdCd;
		this.bseYr = bseYr;
	 ...
	 * @param request
	 * @return SaqAvgWgtLaneVO[]
	 */
	public SaqAvgWgtLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqAvgWgtLaneVO[]
	 */
	public SaqAvgWgtLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqAvgWgtLaneVO model = null;
	 ...
	 * @return SaqAvgWgtLaneVO[]
	 */
	public SaqAvgWgtLaneVO[] fromRequestGridArrayList(HttpServletRequest request, String prefix) {
		SaqAvgWgtLaneVO model = null;
...
//					System.out.println("CntrAvgWgt" +arrTmp[j]);
					if (creUsrId[k] != null)
...
//						model.setInitCntrAvgWgt(initCntrAvgWgt[i]);
	 ...
	 * @return SaqAvgWgtLaneVO[]
	 */
	public SaqAvgWgtLaneVO[] getSaqAvgWgtLaneVOs(){
		SaqAvgWgtLaneVO[] vos = (SaqAvgWgtLaneVO[])models.toArray(new SaqAvgWgtLaneVO[models.size()]);
		return vos;
	}
