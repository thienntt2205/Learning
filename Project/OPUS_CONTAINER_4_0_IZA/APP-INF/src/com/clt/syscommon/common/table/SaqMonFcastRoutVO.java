...
*@FileName : SaqMonFcastRoutVO.java
*@FileTitle : SaqMonFcastRoutVO
*Open Issues :
*Change history :
...
public class SaqMonFcastRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMonFcastRoutVO> models = new ArrayList<SaqMonFcastRoutVO>();
	 ...
	 * @param request
	 * @return SaqMonFcastRoutVO[]
	 */
	public SaqMonFcastRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonFcastRoutVO[]
	 */
	public SaqMonFcastRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMonFcastRoutVO model = null;
	 ...
	 * @return SaqMonFcastRoutVO[]
	 */
	public SaqMonFcastRoutVO[] getSaqMonFcastRoutVOs(){
		SaqMonFcastRoutVO[] vos = (SaqMonFcastRoutVO[])models.toArray(new SaqMonFcastRoutVO[models.size()]);
		return vos;
	}
