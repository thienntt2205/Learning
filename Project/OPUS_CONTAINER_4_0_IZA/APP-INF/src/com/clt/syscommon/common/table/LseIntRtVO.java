...
*@FileName : LseIntRtVO.java
*@FileTitle : LseIntRtVO
*Open Issues :
*Change history :
...
public class LseIntRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LseIntRtVO> models = new ArrayList<LseIntRtVO>();
...
/**
	 ...
	 * @return LseIntRtVO[]
	 */
	public LseIntRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LseIntRtVO[]
	 */
	public LseIntRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LseIntRtVO model = null;
	 ...
	 * @return LseIntRtVO[]
	 */
	public LseIntRtVO[] getLseIntRtVOs(){
		LseIntRtVO[] vos = (LseIntRtVO[])models.toArray(new LseIntRtVO[models.size()]);
		return vos;
	}
