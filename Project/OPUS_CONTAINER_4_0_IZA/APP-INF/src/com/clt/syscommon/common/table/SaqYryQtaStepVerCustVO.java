...
*@FileName : SaqYryQtaStepVerCustVO.java
*@FileTitle : SaqYryQtaStepVerCustVO
*Open Issues :
*Change history :
...
public class SaqYryQtaStepVerCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryQtaStepVerCustVO> models = new ArrayList<SaqYryQtaStepVerCustVO>();
	...
	public SaqYryQtaStepVerCustVO() {}

	public SaqYryQtaStepVerCustVO(String ibflag, String pagerows, String yqtaStepCd, String bseYr, String yqtaVerNo, String keyAcctMgrUsrId, String saqStsCd, String yqtaMdlVerNo, String fnlCfmGdt, String creOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return SaqYryQtaStepVerCustVO[]
	 */
	public SaqYryQtaStepVerCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryQtaStepVerCustVO[]
	 */
	public SaqYryQtaStepVerCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryQtaStepVerCustVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SaqYryQtaStepVerCustVO();
				if (updDt[i] != null)
		...
		return getSaqYryQtaStepVerCustVOs();
	}
	 ...
	 * @return SaqYryQtaStepVerCustVO[]
	 */
	public SaqYryQtaStepVerCustVO[] getSaqYryQtaStepVerCustVOs(){
		SaqYryQtaStepVerCustVO[] vos = (SaqYryQtaStepVerCustVO[])models.toArray(new SaqYryQtaStepVerCustVO[models.size()]);
		return vos;
	}
