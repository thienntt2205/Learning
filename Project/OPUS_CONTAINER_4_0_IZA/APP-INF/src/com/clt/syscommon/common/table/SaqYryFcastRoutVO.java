...
*@FileName : SaqYryFcastRoutVO.java
*@FileTitle : SaqYryFcastRoutVO
*Open Issues :
*Change history :
...
public class SaqYryFcastRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryFcastRoutVO> models = new ArrayList<SaqYryFcastRoutVO>();
	...
	public SaqYryFcastRoutVO() {}

	public SaqYryFcastRoutVO(String ibflag, String pagerows, String slsFcastPubNo, String slsFcastNo, String tsSeq, String vslPrePstCd, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String podCd, String repTrdCd, String repSubTrdCd, String trdCd, String subTrdCd, String iocCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.vslCd = vslCd;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return SaqYryFcastRoutVO[]
	 */
	public SaqYryFcastRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryFcastRoutVO[]
	 */
	public SaqYryFcastRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryFcastRoutVO model = null;
	 ...
	 * @return SaqYryFcastRoutVO[]
	 */
	public SaqYryFcastRoutVO[] getSaqYryFcastRoutVOs(){
		SaqYryFcastRoutVO[] vos = (SaqYryFcastRoutVO[])models.toArray(new SaqYryFcastRoutVO[models.size()]);
		return vos;
	}
