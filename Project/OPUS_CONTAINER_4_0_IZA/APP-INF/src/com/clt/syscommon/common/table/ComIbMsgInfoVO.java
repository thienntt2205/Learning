...
*@FileName : ComIbMsgInfoVO.java
*@FileTitle : ComIbMsgInfoVO
*Open Issues :
*Change history :
...
public class ComIbMsgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComIbMsgInfoVO> models = new ArrayList<ComIbMsgInfoVO>();
	...
	public ComIbMsgInfoVO() {}

	public ComIbMsgInfoVO(String ibflag, String pagerows, String atfcMsgId, String refNo, String subSysCd, String ediMsgTpId, String ediSndrId, String msgQuNm, String msgProcStsCd, String msgProcErrCtnt, String msgTjDt, String creUsrId, String creDt, String updUsrId, String updDt) {
...
/**
	 ...
	 * @param request
	 * @return ComIbMsgInfoVO[]
	 */
	public ComIbMsgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComIbMsgInfoVO[]
	 */
	public ComIbMsgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComIbMsgInfoVO model = null;
	 ...
	 * @return ComIbMsgInfoVO[]
	 */
	public ComIbMsgInfoVO[] getComIbMsgInfoVOs(){
		ComIbMsgInfoVO[] vos = (ComIbMsgInfoVO[])models.toArray(new ComIbMsgInfoVO[models.size()]);
		return vos;
	}
