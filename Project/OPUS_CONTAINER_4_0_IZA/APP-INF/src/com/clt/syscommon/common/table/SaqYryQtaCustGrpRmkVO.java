...
*@FileName : SaqYryQtaCustGrpRmkVO.java
*@FileTitle : SaqYryQtaCustGrpRmkVO
*Open Issues :
*Change history :
...
public class SaqYryQtaCustGrpRmkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryQtaCustGrpRmkVO> models = new ArrayList<SaqYryQtaCustGrpRmkVO>();
	 ...
	 * @param request
	 * @return SaqYryQtaCustGrpRmkVO[]
	 */
	public SaqYryQtaCustGrpRmkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryQtaCustGrpRmkVO[]
	 */
	public SaqYryQtaCustGrpRmkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryQtaCustGrpRmkVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SaqYryQtaCustGrpRmkVO();
				if (updDt[i] != null)
		...
		return getSaqYryQtaCustGrpRmkVOs();
	}
	 ...
	 * @return SaqYryQtaCustGrpRmkVO[]
	 */
	public SaqYryQtaCustGrpRmkVO[] getSaqYryQtaCustGrpRmkVOs(){
		SaqYryQtaCustGrpRmkVO[] vos = (SaqYryQtaCustGrpRmkVO[])models.toArray(new SaqYryQtaCustGrpRmkVO[models.size()]);
		return vos;
	}
