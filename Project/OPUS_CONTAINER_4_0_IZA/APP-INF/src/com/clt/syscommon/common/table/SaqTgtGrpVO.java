...
*@FileName : SaqTgtGrpVO.java
*@FileTitle : SaqTgtGrpVO
*Open Issues :
*Change history :
...
public class SaqTgtGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqTgtGrpVO> models = new ArrayList<SaqTgtGrpVO>();
	...
	public SaqTgtGrpVO(String ibflag, String pagerows, String saqTgtGrpCd, String ofcCd, String saqTgtGrpDesc, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return SaqTgtGrpVO[]
	 */
	public SaqTgtGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqTgtGrpVO[]
	 */
	public SaqTgtGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqTgtGrpVO model = null;
	...
	public SaqTgtGrpVO[] getSaqTgtGrpVOs(){
		SaqTgtGrpVO[] vos = (SaqTgtGrpVO[])models.toArray(new SaqTgtGrpVO[models.size()]);
		return vos;
	}
