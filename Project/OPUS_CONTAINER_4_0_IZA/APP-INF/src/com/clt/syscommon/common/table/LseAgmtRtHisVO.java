...
*@FileName : LseAgmtRtHisVO.java
*@FileTitle : LseAgmtRtHisVO
*Open Issues :
*Change history :
...
public class LseAgmtRtHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LseAgmtRtHisVO> models = new ArrayList<LseAgmtRtHisVO>();
	...
	public LseAgmtRtHisVO() {}

	public LseAgmtRtHisVO(String ibflag, String pagerows, String agmtCtyCd, String agmtSeq, String agmtVerSeq, String locCd, String cntrTpszCd, String cntrRntlChgTpCd, String agmtChgVal, String n1stChgAmt, String n2ndChgAmt, String agmtChgDys, String cntrSpecNo, String genRmk, String creUsrId, String creDt, String updUsrId, String updDt, String eqLocTpCd, String edwUpdDt, String fmDt, String toDt, String lseFmTrDys, String lseToTrDys) {
...
/**
	 ...
	 * @param request
	 * @return LseAgmtRtHisVO[]
	 */
	public LseAgmtRtHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LseAgmtRtHisVO[]
	 */
	public LseAgmtRtHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LseAgmtRtHisVO model = null;
	 ...
	 * @return LseAgmtRtHisVO[]
	 */
	public LseAgmtRtHisVO[] getLseAgmtRtHisVOs(){
		LseAgmtRtHisVO[] vos = (LseAgmtRtHisVO[])models.toArray(new LseAgmtRtHisVO[models.size()]);
		return vos;
	}
