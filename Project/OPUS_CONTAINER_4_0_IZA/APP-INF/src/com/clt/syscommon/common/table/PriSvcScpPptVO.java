...
*@FileName : PriSvcScpPptVO.java
*@FileTitle : PriSvcScpPptVO
*Open Issues :
*Change history :
...
public class PriSvcScpPptVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSvcScpPptVO> models = new ArrayList<PriSvcScpPptVO>();
	...
	public PriSvcScpPptVO() {}

	public PriSvcScpPptVO(String ibflag, String pagerows, String svcScpPptCd, String svcScpPptDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public PriSvcScpPptVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSvcScpPptVO[]
	 */
	public PriSvcScpPptVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSvcScpPptVO model = null;
	...
	public PriSvcScpPptVO[] getPriSvcScpPptVOs(){
		PriSvcScpPptVO[] vos = (PriSvcScpPptVO[])models.toArray(new PriSvcScpPptVO[models.size()]);
		return vos;
	}
