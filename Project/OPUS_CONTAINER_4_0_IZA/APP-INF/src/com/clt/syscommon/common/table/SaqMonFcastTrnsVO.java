...
*@FileName : SaqMonFcastTrnsVO.java
*@FileTitle : SaqMonFcastTrnsVO
*Open Issues :
*Change history :
...
public class SaqMonFcastTrnsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMonFcastTrnsVO> models = new ArrayList<SaqMonFcastTrnsVO>();
	 ...
	 * @param request
	 * @return SaqMonFcastTrnsVO[]
	 */
	public SaqMonFcastTrnsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonFcastTrnsVO[]
	 */
	public SaqMonFcastTrnsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMonFcastTrnsVO model = null;
	 ...
	 * @return SaqMonFcastTrnsVO[]
	 */
	public SaqMonFcastTrnsVO[] getSaqMonFcastTrnsVOs(){
		SaqMonFcastTrnsVO[] vos = (SaqMonFcastTrnsVO[])models.toArray(new SaqMonFcastTrnsVO[models.size()]);
		return vos;
	}
