...
*@FileName : SaqMonDirConvVO.java
*@FileTitle : SaqMonDirConvVO
*Open Issues :
*Change history :
...
public class SaqMonDirConvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMonDirConvVO> models = new ArrayList<SaqMonDirConvVO>();
	...
	public SaqMonDirConvVO() {}

	public SaqMonDirConvVO(String ibflag, String pagerows, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String convDirCd, String subTrdCd, String condStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return SaqMonDirConvVO[]
	 */
	public SaqMonDirConvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonDirConvVO[]
	 */
	public SaqMonDirConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMonDirConvVO model = null;
	 ...
	 * @return SaqMonDirConvVO[]
	 */
	public SaqMonDirConvVO[] fromRequestGrid0163(HttpServletRequest request, String prefix) {
		SaqMonDirConvVO model = null;
		...
		try {
			//저장시 조회조건값
			String bseYr = (JSPUtil.getParameter(request, prefix	+ "bse_yr"));
			String condStsCd = (JSPUtil.getParameter(request, prefix	+ "cond_sts_cd"));
			String bseQtrCd = (JSPUtil.getParameter(request, prefix	+ "bse_qtr_cd"));
	 ...
	 * @return SaqMonDirConvVO[]
	 */
	public SaqMonDirConvVO[] getSaqMonDirConvVOs(){
		SaqMonDirConvVO[] vos = (SaqMonDirConvVO[])models.toArray(new SaqMonDirConvVO[models.size()]);
		return vos;
	}
