...
*@FileName : SaqYryMdlRsltSmryVO.java
*@FileTitle : SaqYryMdlRsltSmryVO
*Open Issues :
*Change history :
...
public class SaqYryMdlRsltSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryMdlRsltSmryVO> models = new ArrayList<SaqYryMdlRsltSmryVO>();
	 ...
	 * @param request
	 * @return SaqYryMdlRsltSmryVO[]
	 */
	public SaqYryMdlRsltSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryMdlRsltSmryVO[]
	 */
	public SaqYryMdlRsltSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryMdlRsltSmryVO model = null;
		...
		return getSaqYryMdlRsltSmryVOs();
	}
	 ...
	 * @return SaqYryMdlRsltSmryVO[]
	 */
	public SaqYryMdlRsltSmryVO[] getSaqYryMdlRsltSmryVOs(){
		SaqYryMdlRsltSmryVO[] vos = (SaqYryMdlRsltSmryVO[])models.toArray(new SaqYryMdlRsltSmryVO[models.size()]);
		return vos;
	}
