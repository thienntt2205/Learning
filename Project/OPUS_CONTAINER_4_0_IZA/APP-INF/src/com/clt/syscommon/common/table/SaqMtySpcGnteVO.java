...
*@FileName : SaqMtySpcGnteVO.java
*@FileTitle : SaqMtySpcGnteVO
*Open Issues :
*Change history :
...
public class SaqMtySpcGnteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMtySpcGnteVO> models = new ArrayList<SaqMtySpcGnteVO>();
	...
	public SaqMtySpcGnteVO() {}

	public SaqMtySpcGnteVO(String ibflag, String pagerows, String bseYr, String bseWk, String rlaneCd, String dirCd, String portCd, String repTrdCd, String repSubTrdCd, String spcGnteQty, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.bseYr = bseYr;
	 ...
	 * @param request
	 * @return SaqMtySpcGnteVO[]
	 */
	public SaqMtySpcGnteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMtySpcGnteVO[]
	 */
	public SaqMtySpcGnteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMtySpcGnteVO model = null;
	 ...
	 * @return SaqMtySpcGnteVO[]
	 */
	public SaqMtySpcGnteVO[] getSaqMtySpcGnteVOs(){
		SaqMtySpcGnteVO[] vos = (SaqMtySpcGnteVO[])models.toArray(new SaqMtySpcGnteVO[models.size()]);
		return vos;
	}
