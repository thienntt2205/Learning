...
*@FileName : SaqMonQtaTrdRmkVO.java
*@FileTitle : SaqMonQtaTrdRmkVO
*Open Issues :
*Change history :
...
public class SaqMonQtaTrdRmkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqMonQtaTrdRmkVO> models = new ArrayList<SaqMonQtaTrdRmkVO>();
	...
	public SaqMonQtaTrdRmkVO() {}

	public SaqMonQtaTrdRmkVO(String ibflag, String pagerows, String mqtaStepCd, String bseYr, String bseQtrCd, String trdCd, String dirCd, String mqtaVerNo, String rlaneCd, String sprtGrpCd, String bsaGrpCd, String ctrtRhqCd, String bseMon, String creSeq, String subjCtnt, String creOfcCd, String cmtCtnt, String rmkCreGdt, String saqStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creSeq = creSeq;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		String rgn_ofc_cd = JSPUtil.getParameter(request, "ctrt_rhq_cd", "");			
		if ( rgn_ofc_cd.equals("") ){
			setCtrtRhqCd(JSPUtil.getParameter(request, "rhq_cd", ""));
		} else {
			setCtrtRhqCd(JSPUtil.getParameter(request, "ctrt_rhq_cd", ""));
		}
	 ...
	 */
	public SaqMonQtaTrdRmkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqMonQtaTrdRmkVO[]
	 */
	public SaqMonQtaTrdRmkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqMonQtaTrdRmkVO model = null;
	 ...
	 * @return SaqMonQtaTrdRmkVO[]
	 */
	public SaqMonQtaTrdRmkVO[] getSaqMonQtaTrdRmkVOs(){
		SaqMonQtaTrdRmkVO[] vos = (SaqMonQtaTrdRmkVO[])models.toArray(new SaqMonQtaTrdRmkVO[models.size()]);
		return vos;
	}
