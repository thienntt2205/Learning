...
*@FileName : SaqYryQtaGlineTrdVO.java
*@FileTitle : SaqYryQtaGlineTrdVO
*Open Issues :
*Change history :
...
public class SaqYryQtaGlineTrdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryQtaGlineTrdVO> models = new ArrayList<SaqYryQtaGlineTrdVO>();
	...
	public SaqYryQtaGlineTrdVO() {}

	public SaqYryQtaGlineTrdVO(String ibflag, String pagerows, String bseYr, String saqTgtGrpCd, String glineVerNo, String trdCd, String dirCd, String bseMon, String lodQty, String grsRev, String cmAmt, String opfitAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.lodQty = lodQty;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setOpfitAmt(JSPUtil.getParameter(request, "opfit_amt", ""));
	 ...
	 * @param request
	 * @return SaqYryQtaGlineTrdVO[]
	 */
	public SaqYryQtaGlineTrdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryQtaGlineTrdVO[]
	 */
	public SaqYryQtaGlineTrdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryQtaGlineTrdVO model = null;
		...
		try {
			...
			String[] opfitAmt = (JSPUtil.getParameter(request, prefix	+ "opfit_amt", length));
		...
		return getSaqYryQtaGlineTrdVOs();
	}
	 ...
	 * @return SaqYryQtaGlineTrdVO[]
	 */
	public SaqYryQtaGlineTrdVO[] getSaqYryQtaGlineTrdVOs(){
		SaqYryQtaGlineTrdVO[] vos = (SaqYryQtaGlineTrdVO[])models.toArray(new SaqYryQtaGlineTrdVO[models.size()]);
		return vos;
	}
