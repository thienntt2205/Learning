...
*@FileName : SaqYryPlnRespbAcctgVO.java
*@FileTitle : SaqYryPlnRespbAcctgVO
*Open Issues :
*Change history :
...
public class SaqYryPlnRespbAcctgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryPlnRespbAcctgVO> models = new ArrayList<SaqYryPlnRespbAcctgVO>();
	...
	public SaqYryPlnRespbAcctgVO() {}

	public SaqYryPlnRespbAcctgVO(String ibflag, String pagerows, String yqtaRlseVerNo, String plnScnrNo, String bseYr, String qtaTgtCd, String bseMon, String trdCd, String rlaneCd, String dirCd, String ctrtRgnOfcCd, String custCntCd, String custSeq, String subTrdCd, String ctrtRhqCd, String ctrtAqCd, String custGrpId, String lodQty, String grsRpbRev, String cmUcAmt, String opfitUcAmt, String raCmUcAmt, String raOpfitUcAmt, String raStpPfitUtAmt, String saqStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 * @param request
	 * @return SaqYryPlnRespbAcctgVO[]
	 */
	public SaqYryPlnRespbAcctgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryPlnRespbAcctgVO[]
	 */
	public SaqYryPlnRespbAcctgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryPlnRespbAcctgVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SaqYryPlnRespbAcctgVO();
				if (cmUcAmt[i] != null)
		...
		return getSaqYryPlnRespbAcctgVOs();
	}
	 ...
	 * @return SaqYryPlnRespbAcctgVO[]
	 */
	public SaqYryPlnRespbAcctgVO[] getSaqYryPlnRespbAcctgVOs(){
		SaqYryPlnRespbAcctgVO[] vos = (SaqYryPlnRespbAcctgVO[])models.toArray(new SaqYryPlnRespbAcctgVO[models.size()]);
		return vos;
	}
