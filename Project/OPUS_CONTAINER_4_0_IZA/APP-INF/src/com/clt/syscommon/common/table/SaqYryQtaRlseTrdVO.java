...
*@FileName : SaqYryQtaRlseTrdVO.java
*@FileTitle : SaqYryQtaRlseTrdVO
*Open Issues :
*Change history :
...
public class SaqYryQtaRlseTrdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryQtaRlseTrdVO> models = new ArrayList<SaqYryQtaRlseTrdVO>();
	...
	public SaqYryQtaRlseTrdVO() {}

	public SaqYryQtaRlseTrdVO(String ibflag, String pagerows, String yqtaRlseVerNo, String trdCd, String dirCd, String saqTgtGrpCd, String yqtaVerNo, String glineVerNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return SaqYryQtaRlseTrdVO[]
	 */
	public SaqYryQtaRlseTrdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryQtaRlseTrdVO[]
	 */
	public SaqYryQtaRlseTrdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SaqYryQtaRlseTrdVO model = null;
	 ...
	 * @return SaqYryQtaRlseTrdVO[]
	 */
	public SaqYryQtaRlseTrdVO[] getSaqYryQtaRlseTrdVOs(){
		SaqYryQtaRlseTrdVO[] vos = (SaqYryQtaRlseTrdVO[])models.toArray(new SaqYryQtaRlseTrdVO[models.size()]);
		return vos;
	}
