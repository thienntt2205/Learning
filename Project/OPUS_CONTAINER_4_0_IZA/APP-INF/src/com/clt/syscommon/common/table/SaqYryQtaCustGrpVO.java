...
*@FileName : SaqYryQtaCustGrpVO.java
*@FileTitle : SaqYryQtaCustGrpVO
*Open Issues :
*Change history :
...
public class SaqYryQtaCustGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SaqYryQtaCustGrpVO> models = new ArrayList<SaqYryQtaCustGrpVO>();
	...
	public SaqYryQtaCustGrpVO() {}

	public SaqYryQtaCustGrpVO(String ibflag, String pagerows, String yqtaStepCd, String bseYr, String yqtaVerNo, String keyAcctMgrUsrId, String custGrpId, String trdCd, String dirCd, String rlaneCd, String bseMon, String ctrtRhqCd, String subTrdCd, String ctrtRgnOfcCd, String lodQty, String grsRpbRev, String cmUcAmt, String opfitUcAmt, String raCmUcAmt, String raStpPfitUtAmt, String raOpfitUcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 * @param request
	 * @return SaqYryQtaCustGrpVO[]
	 */
	public SaqYryQtaCustGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SaqYryQtaCustGrpVO[]
	 */
	public SaqYryQtaCustGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		if(prefix != null && (prefix.equals("0081_fnl"))){
			prefix = prefix.replace("0081_", "");
			return fromRequestGrid0081(request , prefix);
		}else{
	 ...
	 * @return SaqYryQtaCustGrpVO[]
	 */
	public SaqYryQtaCustGrpVO[] fromRequestGrid0081(HttpServletRequest request, String prefix) {
		SaqYryQtaCustGrpVO model = null;
		...
		String[] tmp = request.getParameterValues("ibflag");
  		...
  		try{
			...
			String[] ctrt_rhq_cd = (JSPUtil.getParameter(request,  "ctrt_rhq_cd".trim(), length));
			String[] ctrt_rgn_ofc_cd = (JSPUtil.getParameter(request,  "ctrt_rgn_ofc_cd".trim(), length));
			...
			String[][] rhq_data  = new String[12][];
			for( int mon = 1; mon <= 12 ; mon ++){
				rhq_data[mon-1] = (JSPUtil.getParameter(request,  "hidden_"+prefix+"_"+(mon < 10 ? "0"+mon : String.valueOf(mon) ), length));
			}
			SaqYryQtaCustGrpVO tmpModel;
			for (int i = 0; i < length; i++) {
				...
				for(int mon = 1 ; mon <= 12 ; mon++){
					...
					if (ctrt_rhq_cd[i] != null)
						model.setCtrtRhqCd(ctrt_rhq_cd[i]);	
					
					
					
					if (trd_cd[i] != null)
						model.setTrdCd(trd_cd[i]);	
					if (dir_cd[i] != null)
						model.setDirCd(dir_cd[i]);	
					
					if (ctrt_rgn_ofc_cd[i] != null)
						model.setCtrtRgnOfcCd(ctrt_rgn_ofc_cd[i]);	
					if (cust_grp_id[i] != null)
						model.setCustGrpId(cust_grp_id[i]);	
				
					
					model.setBseMon((mon < 10 ? "0"+mon : String.valueOf(mon) ));	
					if(  item_cd[i].equals("2")  ){ //load이면
						if (rhq_data[mon-1][i] != null){
							model.setLodQty(String.valueOf(Float.parseFloat(rhq_data[mon-1][i]) * unitOffSet) );
						}						
						...
						tmpModel = null;
						while(itr.hasNext()){
							tmpModel = (SaqYryQtaCustGrpVO)itr.next();
							if( tmpModel.getSubTrdCd().equals(sub_trd_cd[i]) 
									&& tmpModel.getRlaneCd().equals(rlane_cd[i])
									&& tmpModel.getCustGrpId().equals(cust_grp_id[i] )
									&& tmpModel.getTrdCd().equals(trd_cd[i] )
									&& tmpModel.getDirCd().equals(dir_cd[i] )
									){
								tmpModel.setGrsRpbRev(String.valueOf(Float.parseFloat(rhq_data[mon-1][i])/unitOffSet) );
								mon++;
								flg = true;
								if( mon > 12 ){
									break;
					...
					if(item_cd[i].equals("5") ){ //rpb이면.
						if (rhq_data[mon-1][i] != null)
							model.setGrsRpbRev(String.valueOf(Float.parseFloat(rhq_data[mon-1][i])/unitOffSet) );
					}
					models.add(model);	
	 ...
	 * @return SaqYryQtaCustGrpVO[]
	 */
	public SaqYryQtaCustGrpVO[] fromRequestGridGeneral(HttpServletRequest request, String prefix) {
		SaqYryQtaCustGrpVO model = null;
	 ...
	 * @return SaqYryQtaCustGrpVO[]
	 */
	public SaqYryQtaCustGrpVO[] getSaqYryQtaCustGrpVOs(){
		SaqYryQtaCustGrpVO[] vos = (SaqYryQtaCustGrpVO[])models.toArray(new SaqYryQtaCustGrpVO[models.size()]);
		return vos;
	}
