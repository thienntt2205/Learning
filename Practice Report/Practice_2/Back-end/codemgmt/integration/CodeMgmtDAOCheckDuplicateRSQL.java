...
*@FileName : CodeMgmtDAOCheckDuplicateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDAOCheckDuplicateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDAOCheckDuplicateRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDAOCheckDuplicateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
